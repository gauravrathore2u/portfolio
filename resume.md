...
Noida, Uttar Pradesh
+91 8630953717 • gauravrathore2u@gmail.com • [LinkedIn](https://www.linkedin.com/in/gauravrathore20) • [GitHub](https://github.com/gauravrathore2u)
...
- **Backend:** Node.js, Express.js, Nest.js, InversifyJS, Jest, Microservices
- **Frontend:** React.js, Next.js, MUI, Redux Toolkit, Tailwind, React Testing Library, Playwright
- **Databases:** PostgreSQL, MongoDB, Redis/Valkey, Qdrant
- **AI:** RAG, LangChain, OpenAI, Claude, Google GenAI, Prompt Engineering, Vector DB
- **Tools:** Docker, Kafka, Socket.io, AWS EC2, NGINX, TypeORM, Git, Claude Code
...
### Systems Engineer, Infosys Ltd. — *Mar 2022 – Sep 2023*
...
### [AI PDF Chat ↗](https://github.com/gauravrathore2u/ai-pdf-chat)
...
### [AI Resume Analyzer ↗](https://github.com/gauravrathore2u/resume-analyzer)
...
**JSS Academy of Technical Education, Noida** — *2016 – 2020*
