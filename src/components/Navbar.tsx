...
export function Navbar() {
    ...
    return (
        ...
        >
            <nav className="flex items-center gap-4 bg-background/80 backdrop-blur-md border border-border/40 rounded-full px-6 py-3 shadow-lg">
                ...
                <div className="flex items-center gap-2">
                    <Button variant="ghost" size="icon" className="rounded-full w-8 h-8" href="https://github.com/gauravrathore2u" target="_blank" rel="noopener noreferrer">
                        <Github className="w-4 h-4" />
                    </Button>
                    <Button variant="ghost" size="icon" className="rounded-full w-8 h-8" href="https://www.linkedin.com/in/gauravrathore20" target="_blank" rel="noopener noreferrer">
